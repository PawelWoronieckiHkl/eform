...
where o.id = ?`;
        ...
        orderDetailsQuery = `SELECT o.id, o.commision, o.created_date, o.sent_date, o.order_idx, o.comment, o.total_price, o.total_price_hidden, u.client_name, u.tax_id, u.ident as user_ident, org.ident as org_ident, CONCAT(u.client_name, ' (', u.ident, ')') as name, u.street, u.zip, u.city, u.country, u.phone, COALESCE(ci.email, u.email) as email
FROM \`order\` o
join \`user\` u on u.id = o.user_id
left join contact_info ci on ci.id = o.contact_info_id
join organization org on org.id = o.organization_id
